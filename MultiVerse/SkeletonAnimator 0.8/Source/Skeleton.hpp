...
class Limb
{
    ...
    void Draw(Application & App, bool DrawBones)
    {
        Position = SkeletonCenter->Vector;
        Rotation = Angle(SkeletonCenter->Vector, SkeletonPoint->Vector) * -DPR;
...
//        lLegPosition = RotatePoint(lLegPosition, Vector2f(0, 0), -Angle(bones.vectors.Find("CenterBody")->Vector, bones.vectors.Find("CenterHead")->Vector)*DPR-90);
    ...
    void Draw(Application & App, bool DrawBones, bool DrawAll)
    {
        ...
        bones.vectors.Find("CenterRUpperarm")->Vector = bones.vectors.Find("CenterBody")->Vector + RotatePoint(rArmPosition, Vector2f(0, 0), Angle(bones.vectors.Find("CenterBody")->Vector, bones.vectors.Find("CenterHead")->Vector)*DPR+90);
        bones.vectors.Find("CenterLUpperarm")->Vector = bones.vectors.Find("CenterBody")->Vector + RotatePoint(lArmPosition, Vector2f(0, 0), Angle(bones.vectors.Find("CenterBody")->Vector, bones.vectors.Find("CenterHead")->Vector)*DPR+90);
        bones.vectors.Find("CenterRHip")->Vector = bones.vectors.Find("CenterBody")->Vector + RotatePoint(rLegPosition, Vector2f(0, 0), Angle(bones.vectors.Find("CenterBody")->Vector, bones.vectors.Find("CenterHead")->Vector)*DPR+90);
        bones.vectors.Find("CenterLHip")->Vector = bones.vectors.Find("CenterBody")->Vector + RotatePoint(lLegPosition, Vector2f(0, 0), Angle(bones.vectors.Find("CenterBody")->Vector, bones.vectors.Find("CenterHead")->Vector)*DPR+90);
        ...
        for(int i = lLeg.GetSize()-1; i >= 0; i--)
        {
            ...
            lLeg[i]->Draw(App, DrawBones);
        }

        if(GUI::Numpad5Key() || DrawAll)
        for(int i = 0; i < Body.GetSize(); i++)
        {
            Body[i]->SkeletonCenter->Vector += Position - PrevPosition;
            if(i == Body.GetSize()-1)
            Body[i]->SkeletonPoint->Vector += Position - PrevPosition;

            Body[i]->Draw(App, DrawBones);
        }
